		...
		<div class="container-register">
			<div class="wrap-register">
                ...
                <div class='register -head'>
					<span class="login100-form-title padding-bot-10">
						Register
					</span>
                    ...
                    <div class='register-body'>
                        <div class='register-left'>
                            <div class="wrap-input100">
                                <input class="input100" type="text" name="name" placeholder="Name" v-model='name'>
					...
					<div class="container-login100-form-btn padding-top-20">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" type="submit" v-on:click="register">
								Register
							</button>
						</div>
					</div>
